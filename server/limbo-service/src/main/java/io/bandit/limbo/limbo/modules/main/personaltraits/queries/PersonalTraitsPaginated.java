...
public class PersonalTraitsPaginated {
    ...
    @Named("PersonalTraitsPaginated.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
        ...
        public CompletableFuture<Paginated<PersonalTraits>> handle(final Query query) {
            ...
            return CompletableFuture.supplyAsync(() -> {
                final Page<PersonalTraits> result = repository.findAll(
                        query.getFilters(),
                        query.getPage(),
                        query.getSort());
