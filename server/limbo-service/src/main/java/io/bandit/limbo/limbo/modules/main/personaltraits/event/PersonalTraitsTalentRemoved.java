...
public class PersonalTraitsTalentRemoved extends DomainEvent<PersonalTraits> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "personal_traits.talent.removed";

    public PersonalTraitsTalentRemoved(final PersonalTraits personalTraits) {
    ...
    private Payload buildPayload(final PersonalTraits personalTraits) {
        ...
        return new Payload(personalTraits.getId(),personalTraits.getTalent().getId());
    }
    ...
    public class Payload implements DomainEvent.Payload {
        ...
        public Payload(String talentId, String personalTraitsId) {
