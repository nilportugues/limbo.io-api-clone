...
public class TalentTalentProfileDelete {
    ...
    @Named("TalentTalentProfileDelete.CommandHandler")
    public static class CommandHandler implements ICommandHandler<Command> {
        ...
        /**
         * Delete the current TalentProfile value for a given Talent.
         */
        public CompletableFuture<Talent> handle(final Command command) {
        //public Mono<Talent> deleteTalentProfile(final Command command) {

            return CompletableFuture.supplyAsync(() -> {
                final Talent talent = talentRepository.findOneWithTalentProfile(command.getTalentId());
