...
@ApiModel
public class SkillsPaginatedResponse implements SkillsJsonResponse {
    ...
    protected List<SkillsResponse> embedded;
    ...
    public SkillsPaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<Skills> page) {
    ...
    private void setData(final Paginated<Skills> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> SkillsResponse.fromSkills(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<Skills> page) {
