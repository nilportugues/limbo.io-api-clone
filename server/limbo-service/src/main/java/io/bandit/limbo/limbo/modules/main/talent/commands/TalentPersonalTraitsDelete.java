...
public class TalentPersonalTraitsDelete {
    ...
    @Named("TalentPersonalTraitsDelete.CommandHandler")
    public static class CommandHandler implements ICommandHandler<Command> {
        ...
        /**
         * Delete all PersonalTraits for a given Talents.
         */
        ...
        //public Talent deleteAll(final Command command) {
            ...
            return CompletableFuture.supplyAsync(() -> {
                ...
                if (null != talent) {
                    ...
                    findTalentWithPersonalTraits(talent);
                    createDeleteEvents(domainEvents, talent);
                    deleteAllPersonalTraits(talent);
        ...
        private void createDeleteEvents(final List<DomainEvent> domainEvents, final Talent talent) {
            talent.getPersonalTraits().forEach(v -> domainEvents.add(new PersonalTraitsDeleted(v)));
        }

        private void deleteAllPersonalTraits(final Talent talent) {
            talentRepository.deleteAllPersonalTraits(talent.getId());
        }
        ...
        public void deleteAllPersonalTraits(final String talentId) {
            ...
            if (Optional.ofNullable(talent).isPresent()) {
                talentRepository.deleteAllPersonalTraits(talentId);
            }
        }
        ...
        private Talent findTalentWithPersonalTraits(final Talent talent) {
            return talentRepository.findOneWithPersonalTraits(talent.getId());
        }
    }
}
