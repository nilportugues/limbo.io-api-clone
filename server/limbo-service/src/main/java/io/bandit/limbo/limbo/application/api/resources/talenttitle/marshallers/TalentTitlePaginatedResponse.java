...
@ApiModel
public class TalentTitlePaginatedResponse implements TalentTitleJsonResponse {
    ...
    protected List<TalentTitleResponse> embedded;
    ...
    public TalentTitlePaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<TalentTitle> page) {
    ...
    private void setData(final Paginated<TalentTitle> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> TalentTitleResponse.fromTalentTitle(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<TalentTitle> page) {
