...
/**
 * A CompanyTraits Model.
 */
@Entity
@Table(name = "company_traits")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CompanyTraitsJpaModel implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        CompanyTraitsJpaModel companyTraits = (CompanyTraitsJpaModel) o;
