...
public class PersonalTraitsForbidden extends VndError {

    public PersonalTraitsForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the PersonalTraits resource."));
