...
public class TalentCountry {
    ...
    @Named("TalentCountry.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
        ...
        /**
         * Get one Talent by id with Country relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {
            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithCountry(query.getId()));
        }
    }
}
