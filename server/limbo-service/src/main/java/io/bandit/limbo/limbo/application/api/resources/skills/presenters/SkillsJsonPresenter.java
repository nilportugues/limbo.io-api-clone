...
@Named("SkillsJsonPresenter")
public class SkillsJsonPresenter implements SkillsOutputBoundary {

    private static final String NOT_FOUND_MESSAGE = "Skills with id '%s' was not found.";
    ...
    private final SkillsHttpRouter router;

    public SkillsJsonPresenter(final ObjectMapper objectMapper, final SkillsHttpRouter router) {
        this.objectMapper = objectMapper;
        this.router = router;
    }

    public String success(final Skills skills) {
        try {
            final SkillsResponse response = SkillsResponse.fromSkills(
                    skills,
                    router.getSkillsRoute(),
                    router.getSkillsRoute(skills.getId()));
    ...
    public String notFound(final String skillsId) {
        try {

            final String message = String.format(NOT_FOUND_MESSAGE, skillsId);
    ...
    public String paginatedResponse(final String queryParams, final Paginated<Skills> page) {
        try {
            final SkillsPaginatedResponse response = new SkillsPaginatedResponse(
            router.getSkillsRoute(),
            queryParams,
            page);
