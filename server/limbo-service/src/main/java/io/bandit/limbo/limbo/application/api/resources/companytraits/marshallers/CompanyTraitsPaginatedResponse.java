...
@ApiModel
public class CompanyTraitsPaginatedResponse implements CompanyTraitsJsonResponse {
    ...
    protected List<CompanyTraitsResponse> embedded;
    ...
    public CompanyTraitsPaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<CompanyTraits> page) {
    ...
    private void setData(final Paginated<CompanyTraits> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> CompanyTraitsResponse.fromCompanyTraits(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<CompanyTraits> page) {
