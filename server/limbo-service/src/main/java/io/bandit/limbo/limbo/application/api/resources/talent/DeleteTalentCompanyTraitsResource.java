...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentCompanyTraitsDelete;
...
@RestController
public class DeleteTalentCompanyTraitsResource {
    ...
    @Inject
    public DeleteTalentCompanyTraitsResource(
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_COMPANYTRAITS_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> delete(@PathVariable String id) {
        ...
        return Mono.fromFuture(commandBus.execute(new TalentCompanyTraitsDelete.Command(id)))
