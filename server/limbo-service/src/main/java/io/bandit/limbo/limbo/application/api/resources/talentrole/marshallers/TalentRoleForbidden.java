...
public class TalentRoleForbidden extends VndError {

    public TalentRoleForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the TalentRole resource."));
