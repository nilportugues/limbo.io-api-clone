...
public class TalentExperienceForbidden extends VndError {

    public TalentExperienceForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the TalentExperience resource."));
