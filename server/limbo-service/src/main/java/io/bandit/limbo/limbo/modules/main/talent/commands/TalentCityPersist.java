...
public class TalentCityPersist {

    public static class Command implements ICommand {
        private String talentId;
        private City city;

        public Command(final String talentId, final City city) {
    ...
    @Named("TalentCityPersist.CommandHandler")
    public static class CommandHandler implements ICommandHandler<Command> {
        ...
        /**
         * Persist the current City value for a given Talent.
         */
        public CompletableFuture<Talent> handle(final Command command) {
            return CompletableFuture.supplyAsync(() -> {
                try {
                    ...
                    talent.setCity(command.getCity());
