...
public class TalentPersonalTraits {
    ...
    @Named("TalentPersonalTraits.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
       ...
       /**
         * Get one Talent by id with PersonalTraits relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {

            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithPersonalTraits(query.getId()));
        }
    }
}
