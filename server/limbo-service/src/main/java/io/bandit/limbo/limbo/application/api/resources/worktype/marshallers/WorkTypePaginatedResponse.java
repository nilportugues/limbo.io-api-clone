...
@ApiModel
public class WorkTypePaginatedResponse implements WorkTypeJsonResponse {
    ...
    protected List<WorkTypeResponse> embedded;
    ...
    public WorkTypePaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<WorkType> page) {
    ...
    private void setData(final Paginated<WorkType> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> WorkTypeResponse.fromWorkType(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<WorkType> page) {
