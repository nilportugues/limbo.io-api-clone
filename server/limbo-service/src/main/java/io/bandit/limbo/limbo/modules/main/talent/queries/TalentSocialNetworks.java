...
public class TalentSocialNetworks {
    ...
    @Named("TalentSocialNetworks.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
       ...
       /**
         * Get one Talent by id with SocialNetworks relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {

            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithSocialNetworks(query.getId()));
        }
    }
}
