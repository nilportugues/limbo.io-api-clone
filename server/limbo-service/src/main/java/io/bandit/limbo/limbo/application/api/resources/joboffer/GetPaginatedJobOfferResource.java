...
import io.bandit.limbo.limbo.modules.main.joboffer.queries.JobOfferPaginated;
...
@RestController
public class GetPaginatedJobOfferResource {

    private static final String SWAGGER_DOC_TAG = "Job Offer";
    private static final String SWAGGER_DOC_GET_MANY = "Get all the job offers.";
    ...
    @Inject
    public GetPaginatedJobOfferResource(final IQueryBus queryBus,
    ...
    @RequestMapping(value = JobOfferHttpRouter.JOBOFFER_MANY_ROUTE, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> getAll() throws Throwable {
        ...
        return Mono.fromFuture(queryBus.dispatch(new JobOfferPaginated.Query(fieldsOptions, filterOptions, pageOptions, sortOptions)))
