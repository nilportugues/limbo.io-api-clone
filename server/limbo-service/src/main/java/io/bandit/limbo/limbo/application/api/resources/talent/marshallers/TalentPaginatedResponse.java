...
@ApiModel
public class TalentPaginatedResponse implements TalentJsonResponse {
    ...
    protected List<TalentResponse> embedded;
    ...
    public TalentPaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<Talent> page) {
    ...
    private void setData(final Paginated<Talent> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> TalentResponse.fromTalent(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<Talent> page) {
