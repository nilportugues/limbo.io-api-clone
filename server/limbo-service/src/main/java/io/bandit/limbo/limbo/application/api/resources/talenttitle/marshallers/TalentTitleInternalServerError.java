...
public class TalentTitleInternalServerError extends VndError {

    public TalentTitleInternalServerError() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("TalentTitle resource is not reachable."));
