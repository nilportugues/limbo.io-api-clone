...
@ApiModel
public class TalentExperiencePaginatedResponse implements TalentExperienceJsonResponse {
    ...
    protected List<TalentExperienceResponse> embedded;
    ...
    public TalentExperiencePaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<TalentExperience> page) {
    ...
    private void setData(final Paginated<TalentExperience> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> TalentExperienceResponse.fromTalentExperience(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<TalentExperience> page) {
