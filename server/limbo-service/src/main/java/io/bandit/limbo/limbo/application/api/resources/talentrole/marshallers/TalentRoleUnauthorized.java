...
public class TalentRoleUnauthorized extends VndError {

    public TalentRoleUnauthorized()  {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Credentials required to access the TalentRole resource."));
