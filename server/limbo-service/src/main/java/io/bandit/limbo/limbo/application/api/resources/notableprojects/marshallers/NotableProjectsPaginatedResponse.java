...
@ApiModel
public class NotableProjectsPaginatedResponse implements NotableProjectsJsonResponse {
    ...
    protected List<NotableProjectsResponse> embedded;
    ...
    public NotableProjectsPaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<NotableProjects> page) {
    ...
    private void setData(final Paginated<NotableProjects> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> NotableProjectsResponse.fromNotableProjects(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<NotableProjects> page) {
