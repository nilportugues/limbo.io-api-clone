...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentNotableProjectsDelete;
...
@RestController
public class DeleteTalentNotableProjectsResource {
    ...
    @Inject
    public DeleteTalentNotableProjectsResource(
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_NOTABLEPROJECTS_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> delete(@PathVariable String id) {
        ...
        return Mono.fromFuture(commandBus.execute(new TalentNotableProjectsDelete.Command(id)))
