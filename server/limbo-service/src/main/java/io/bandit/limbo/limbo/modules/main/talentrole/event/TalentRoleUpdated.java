...
public class TalentRoleUpdated extends DomainEvent<TalentRole> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "talent_role.updated";

    public TalentRoleUpdated(final TalentRole talentRole) {
