...
public class NotableProjectsForbidden extends VndError {

    public NotableProjectsForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the NotableProjects resource."));
