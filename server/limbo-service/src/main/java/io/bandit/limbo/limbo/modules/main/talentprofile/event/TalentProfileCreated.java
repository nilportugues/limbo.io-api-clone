...
public class TalentProfileCreated extends DomainEvent<TalentProfile> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "talent_profile.created";

    public TalentProfileCreated(final TalentProfile talentProfile) {
