...
public class SocialNetworksForbidden extends VndError {

    public SocialNetworksForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the SocialNetworks resource."));
