...
@ApiModel
public class SocialNetworksPaginatedResponse implements SocialNetworksJsonResponse {
    ...
    protected List<SocialNetworksResponse> embedded;
    ...
    public SocialNetworksPaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<SocialNetworks> page) {
    ...
    private void setData(final Paginated<SocialNetworks> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> SocialNetworksResponse.fromSocialNetworks(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<SocialNetworks> page) {
