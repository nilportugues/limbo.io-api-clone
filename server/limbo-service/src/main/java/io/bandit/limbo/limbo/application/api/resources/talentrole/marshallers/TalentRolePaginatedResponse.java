...
@ApiModel
public class TalentRolePaginatedResponse implements TalentRoleJsonResponse {
    ...
    protected List<TalentRoleResponse> embedded;
    ...
    public TalentRolePaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<TalentRole> page) {
    ...
    private void setData(final Paginated<TalentRole> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> TalentRoleResponse.fromTalentRole(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<TalentRole> page) {
