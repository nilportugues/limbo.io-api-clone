...
public class CompanyTraitsForbidden extends VndError {

    public CompanyTraitsForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the CompanyTraits resource."));
