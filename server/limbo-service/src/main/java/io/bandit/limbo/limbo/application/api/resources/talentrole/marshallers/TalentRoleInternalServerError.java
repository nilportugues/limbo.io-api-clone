...
public class TalentRoleInternalServerError extends VndError {

    public TalentRoleInternalServerError() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("TalentRole resource is not reachable."));
