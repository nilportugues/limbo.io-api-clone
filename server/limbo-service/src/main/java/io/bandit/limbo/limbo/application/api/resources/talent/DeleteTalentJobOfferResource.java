...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentJobOfferDelete;
...
@RestController
public class DeleteTalentJobOfferResource {
    ...
    @Inject
    public DeleteTalentJobOfferResource(
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_JOBOFFER_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> delete(@PathVariable String id) {
        ...
        return Mono.fromFuture(commandBus.execute(new TalentJobOfferDelete.Command(id)))
