...
public class SocialNetworksUnauthorized extends VndError {

    public SocialNetworksUnauthorized()  {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Credentials required to access the SocialNetworks resource."));
