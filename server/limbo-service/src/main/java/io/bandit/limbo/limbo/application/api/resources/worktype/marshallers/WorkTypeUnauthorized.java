...
public class WorkTypeUnauthorized extends VndError {

    public WorkTypeUnauthorized()  {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Credentials required to access the WorkType resource."));
