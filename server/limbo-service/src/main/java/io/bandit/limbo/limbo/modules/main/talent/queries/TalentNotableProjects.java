...
public class TalentNotableProjects {
    ...
    @Named("TalentNotableProjects.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
       ...
       /**
         * Get one Talent by id with NotableProjects relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {

            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithNotableProjects(query.getId()));
        }
    }
}
