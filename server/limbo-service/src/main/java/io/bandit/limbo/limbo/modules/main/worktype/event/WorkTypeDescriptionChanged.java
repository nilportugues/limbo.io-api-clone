...
public class WorkTypeDescriptionChanged extends DomainEvent<WorkType> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "work_type.description.changed";

    public WorkTypeDescriptionChanged(final WorkType workType) {
    ...
    private Payload buildPayload(final WorkType workType) {
        ...
        return new Payload(workType.getId(),workType.getDescription());
    }
    ...
    public class Payload implements DomainEvent.Payload {
        ...
        public Payload(String workTypeId, String description) {
