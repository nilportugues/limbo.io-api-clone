...
public class NotableProjectsInternalServerError extends VndError {

    public NotableProjectsInternalServerError() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("NotableProjects resource is not reachable."));
