...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentNotableProjectsDeleteMany;
...
@RestController
public class DeleteBulkTalentNotableProjectsResource {

    private static final String SWAGGER_DOC_TAG = "Talent";
    private static final String SWAGGER_DOC_DELETE_MANY_NOTABLE_PROJECTS = "Removes the talents for the current notable projects.";
    ...
    @Inject
    public DeleteBulkTalentNotableProjectsResource(
    ...
    @ApiOperation(value = SWAGGER_DOC_DELETE_MANY_NOTABLE_PROJECTS, tags = {SWAGGER_DOC_TAG})
    @RequestMapping(value = TalentHttpRouter.TALENT_NOTABLEPROJECTS_DELETE_BATCH_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> deleteBulk(@PathVariable String id, @RequestBody String[] ids) {

        final TalentNotableProjectsDeleteMany.Command command = new TalentNotableProjectsDeleteMany.Command(id, Arrays.asList(ids));
    ...
    private ResponseEntity<String> deleteView(final Object object) {
        metrics.incrementTalentNotableProjectsDeleted();
