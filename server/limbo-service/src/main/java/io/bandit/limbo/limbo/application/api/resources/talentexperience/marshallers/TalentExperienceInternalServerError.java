...
public class TalentExperienceInternalServerError extends VndError {

    public TalentExperienceInternalServerError() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("TalentExperience resource is not reachable."));
