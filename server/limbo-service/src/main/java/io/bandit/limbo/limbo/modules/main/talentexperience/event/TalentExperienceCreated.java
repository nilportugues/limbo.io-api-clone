...
public class TalentExperienceCreated extends DomainEvent<TalentExperience> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "talent_experience.created";

    public TalentExperienceCreated(final TalentExperience talentExperience) {
