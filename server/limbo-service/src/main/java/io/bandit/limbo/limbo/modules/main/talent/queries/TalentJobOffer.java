...
public class TalentJobOffer {
    ...
    @Named("TalentJobOffer.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
       ...
       /**
         * Get one Talent by id with JobOffer relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {

            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithJobOffers(query.getId()));
        }
    }
}
