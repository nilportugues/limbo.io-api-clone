...
public class TalentTalentProfile {
    ...
    @Named("TalentTalentProfile.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
        ...
        /**
         * Get one Talent by id with TalentProfile relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {
            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithTalentProfile(query.getId()));
        }
    }
}
