...
import io.bandit.limbo.limbo.modules.main.country.commands.CountryCityDeleteMany;
...
@RestController
public class DeleteBulkCountryCityResource {
    ...
    @Inject
    public DeleteBulkCountryCityResource(
    ...
    @RequestMapping(value = CountryHttpRouter.COUNTRY_CITY_DELETE_BATCH_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> deleteBulk(@PathVariable String id, @RequestBody String[] ids) {
        ...
        final CountryCityDeleteMany.Command command = new CountryCityDeleteMany.Command(id, Arrays.asList(ids));
