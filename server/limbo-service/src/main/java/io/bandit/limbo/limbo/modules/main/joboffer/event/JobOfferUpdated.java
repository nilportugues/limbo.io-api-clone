...
public class JobOfferUpdated extends DomainEvent<JobOffer> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "job_offer.updated";

    public JobOfferUpdated(final JobOffer jobOffer) {
