...
public class TalentTalentExperience {
    ...
    @Named("TalentTalentExperience.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
        ...
        /**
         * Get one Talent by id with TalentExperience relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {
            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithTalentExperience(query.getId()));
        }
    }
}
