...
public class TalentExperienceUnauthorized extends VndError {

    public TalentExperienceUnauthorized()  {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Credentials required to access the TalentExperience resource."));
