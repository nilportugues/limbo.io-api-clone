package io.bandit.limbo.limbo.infrastructure.hazzlecast.hibernate;
...
import io.bandit.limbo.limbo.infrastructure.hazzlecast.CacheConfiguration;
...
public class HazelcastCacheRegionFactory implements RegionFactory {
    ...
    public final QueryResultsRegion buildQueryResultsRegion(final String regionName,
    ...
    public CollectionRegion buildCollectionRegion(final String regionName,
        ...
        HazelcastCollectionRegion<LocalRegionCache> region = new HazelcastCollectionRegion<>(
                hazelcastInstance,
                regionName,
                properties,
                metadata,
    ...
    public TimestampsRegion buildTimestampsRegion(final String regionName,
        ...
        return new HazelcastTimestampsRegion<>(
                hazelcastInstance,
                regionName,
                properties,
