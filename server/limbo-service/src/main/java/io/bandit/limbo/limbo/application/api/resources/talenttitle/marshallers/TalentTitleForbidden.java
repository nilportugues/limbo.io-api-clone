...
public class TalentTitleForbidden extends VndError {

    public TalentTitleForbidden() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Insufficient credentials to access the TalentTitle resource."));
