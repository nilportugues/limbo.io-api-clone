...
public class TalentCompanyTraits {
    ...
    @Named("TalentCompanyTraits.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
       ...
       /**
         * Get one Talent by id with CompanyTraits relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {

            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithCompanyTraits(query.getId()));
        }
    }
}
