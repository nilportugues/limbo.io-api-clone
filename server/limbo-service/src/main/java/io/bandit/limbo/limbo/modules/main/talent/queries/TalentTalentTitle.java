...
public class TalentTalentTitle {
    ...
    @Named("TalentTalentTitle.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
        ...
        /**
         * Get one Talent by id with TalentTitle relationship data.
         *
         * @return the Talent entity
         */
        public CompletableFuture<Talent> handle(final Query query) {
            return CompletableFuture.supplyAsync(() -> talentRepository.findOneWithTalentTitle(query.getId()));
        }
    }
}
