...
import io.bandit.limbo.limbo.modules.main.socialnetworks.queries.SocialNetworksTalentPaginated;
...
@RestController
public class GetTalentSocialNetworksResource {

    private static final String SWAGGER_DOC_TAG = "Talent";
    private static final String SWAGGER_DOC_GET_MANY_SOCIAL_NETWORKS= "Gets the SocialNetworks for the current Talents.";
    ...
    @Inject
    public GetTalentSocialNetworksResource(final IQueryBus queryBus,
    ...
    @ApiOperation(value = SWAGGER_DOC_GET_MANY_SOCIAL_NETWORKS, tags = {SWAGGER_DOC_TAG})
    @ApiImplicitParams({
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_SOCIALNETWORKS_ROUTE, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> get(@PathVariable String id) {
        ...
        return Mono.fromFuture(queryBus.dispatch(new SocialNetworksTalentPaginated.Query(id, fieldsOptions, filterOptions, pageOptions, sortOptions)))
    ...
    private ResponseEntity<String> paginatedView(final Paginated<SocialNetworks> page,
        ...
        try {
            ...
            metrics.incrementTalentSocialNetworksSuccess();
