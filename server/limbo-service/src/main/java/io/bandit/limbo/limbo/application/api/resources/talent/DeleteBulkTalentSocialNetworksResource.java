...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentSocialNetworksDeleteMany;
...
@RestController
public class DeleteBulkTalentSocialNetworksResource {
    ...
    @Inject
    public DeleteBulkTalentSocialNetworksResource(
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_SOCIALNETWORKS_DELETE_BATCH_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> deleteBulk(@PathVariable String id, @RequestBody String[] ids) {
        ...
        final TalentSocialNetworksDeleteMany.Command command = new TalentSocialNetworksDeleteMany.Command(id, Arrays.asList(ids));
