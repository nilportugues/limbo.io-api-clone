...
public class SocialNetworksTalentPaginated {
    ...
    @Named("SocialNetworksTalentPaginated.QueryHandler")
    public static class QueryHandler implements IQueryHandler<Query> {
        ...
        /**
         * Get SocialNetworks as pages given a Talent id.
         *
        ...
        public CompletableFuture<Paginated<SocialNetworks>> handle(final Query query) {
            return CompletableFuture.supplyAsync(() -> {
                final Page<SocialNetworks> result = socialNetworksRepository.findByTalent(
                        query.getId(),
                        query.getFilters(),
                        query.getPage(),
                        query.getSort());
