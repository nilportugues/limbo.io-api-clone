...
public class CompanyTraitsTitleChanged extends DomainEvent<CompanyTraits> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "company_traits.title.changed";

    public CompanyTraitsTitleChanged(final CompanyTraits companyTraits) {
    ...
    private Payload buildPayload(final CompanyTraits companyTraits) {
        ...
        return new Payload(companyTraits.getId(),companyTraits.getTitle());
    }
    ...
    public class Payload implements DomainEvent.Payload {
        ...
        public Payload(String companyTraitsId, String title) {
