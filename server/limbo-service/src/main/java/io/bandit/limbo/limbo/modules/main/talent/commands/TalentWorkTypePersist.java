...
public class TalentWorkTypePersist {

    public static class Command implements ICommand {
        private String talentId;
        private WorkType workType;

        public Command(final String talentId, final WorkType workType) {
    ...
    @Named("TalentWorkTypePersist.CommandHandler")
    public static class CommandHandler implements ICommandHandler<Command> {
        ...
        /**
         * Persist the current WorkType value for a given Talent.
         */
        public CompletableFuture<Talent> handle(final Command command) {
            return CompletableFuture.supplyAsync(() -> {
                try {
                    ...
                    talent.setWorkType(command.getWorkType());
