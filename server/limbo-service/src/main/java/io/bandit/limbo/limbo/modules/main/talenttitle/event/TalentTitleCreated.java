...
public class TalentTitleCreated extends DomainEvent<TalentTitle> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "talent_title.created";

    public TalentTitleCreated(final TalentTitle talentTitle) {
