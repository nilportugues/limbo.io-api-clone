...
@ApiModel
public class JobOfferPaginatedResponse implements JobOfferJsonResponse {
    ...
    protected List<JobOfferResponse> embedded;
    ...
    public JobOfferPaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<JobOffer> page) {
    ...
    private void setData(final Paginated<JobOffer> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> JobOfferResponse.fromJobOffer(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<JobOffer> page) {
