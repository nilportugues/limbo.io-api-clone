...
public class TalentProfileUnauthorized extends VndError {

    public TalentProfileUnauthorized()  {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("Credentials required to access the TalentProfile resource."));
