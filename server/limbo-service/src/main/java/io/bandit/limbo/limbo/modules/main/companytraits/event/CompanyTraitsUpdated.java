...
public class CompanyTraitsUpdated extends DomainEvent<CompanyTraits> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "company_traits.updated";

    public CompanyTraitsUpdated(final CompanyTraits companyTraits) {
