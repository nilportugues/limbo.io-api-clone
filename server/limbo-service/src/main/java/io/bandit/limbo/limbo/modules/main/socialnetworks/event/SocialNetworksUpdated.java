...
public class SocialNetworksUpdated extends DomainEvent<SocialNetworks> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "social_networks.updated";

    public SocialNetworksUpdated(final SocialNetworks socialNetworks) {
