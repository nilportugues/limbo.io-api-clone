...
public class WorkTypeUpdated extends DomainEvent<WorkType> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "work_type.updated";

    public WorkTypeUpdated(final WorkType workType) {
