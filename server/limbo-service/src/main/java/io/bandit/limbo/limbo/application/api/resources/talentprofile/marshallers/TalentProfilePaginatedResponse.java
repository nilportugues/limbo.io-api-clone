...
@ApiModel
public class TalentProfilePaginatedResponse implements TalentProfileJsonResponse {
    ...
    protected List<TalentProfileResponse> embedded;
    ...
    public TalentProfilePaginatedResponse(
            final String pageUrl,
            final String queryParams,
            final Paginated<TalentProfile> page) {
    ...
    private void setData(final Paginated<TalentProfile> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> TalentProfileResponse.fromTalentProfile(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<TalentProfile> page) {
