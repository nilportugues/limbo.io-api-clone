...
@ApiModel
public class CityPaginatedResponse implements CityJsonResponse {
    ...
    protected List<CityResponse> embedded;
    ...
    private void setData(final Paginated<City> page, final String pageUrl) {

        embedded = page.getContent()
            .stream()
            .map(v -> CityResponse.fromCity(v, pageUrl, pageUrl+"/"+v.getId()))
            .collect(Collectors.toList());
    }

    private void setLinks(final String pageUrl, final String queryParams, final Paginated<City> page) {
