...
public class TalentDeleted extends DomainEvent<Talent> {

    @JsonIgnore
    private static final Integer EVENT_VERSION = 1;

    @JsonIgnore
    public static final String EVENT_NAME = "talent.deleted";

    public TalentDeleted(final Talent talent) {
    ...
    private Payload buildPayload(final Talent talent) {
        ...
        return new Payload(talent.getId());
    }
    ...
    public class Payload implements DomainEvent.Payload {
        ...
        public Payload(String talentId) {
