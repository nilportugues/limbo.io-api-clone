...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentSkillsDeleteMany;
...
@RestController
public class DeleteBulkTalentSkillsResource {
    ...
    @Inject
    public DeleteBulkTalentSkillsResource(
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_SKILLS_DELETE_BATCH_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> deleteBulk(@PathVariable String id, @RequestBody String[] ids) {
        ...
        final TalentSkillsDeleteMany.Command command = new TalentSkillsDeleteMany.Command(id, Arrays.asList(ids));
