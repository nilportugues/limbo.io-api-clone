...
public class TalentTalentExperienceDelete {
    ...
    @Named("TalentTalentExperienceDelete.CommandHandler")
    public static class CommandHandler implements ICommandHandler<Command> {
        ...
        /**
         * Delete the current TalentExperience value for a given Talent.
         */
        public CompletableFuture<Talent> handle(final Command command) {
        //public Mono<Talent> deleteTalentExperience(final Command command) {

            return CompletableFuture.supplyAsync(() -> {
                final Talent talent = talentRepository.findOneWithTalentExperience(command.getTalentId());
