...
public class SocialNetworksInternalServerError extends VndError {

    public SocialNetworksInternalServerError() {
        final ArrayList<Error> errors = new ArrayList<>();
        errors.add(new Error("SocialNetworks resource is not reachable."));
