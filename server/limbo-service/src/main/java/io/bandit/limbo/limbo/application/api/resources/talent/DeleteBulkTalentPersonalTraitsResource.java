...
import io.bandit.limbo.limbo.modules.main.talent.commands.TalentPersonalTraitsDeleteMany;
...
@RestController
public class DeleteBulkTalentPersonalTraitsResource {
    ...
    @Inject
    public DeleteBulkTalentPersonalTraitsResource(
    ...
    @RequestMapping(value = TalentHttpRouter.TALENT_PERSONALTRAITS_DELETE_BATCH_ROUTE, method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public Future<ResponseEntity<String>> deleteBulk(@PathVariable String id, @RequestBody String[] ids) {
        ...
        final TalentPersonalTraitsDeleteMany.Command command = new TalentPersonalTraitsDeleteMany.Command(id, Arrays.asList(ids));
